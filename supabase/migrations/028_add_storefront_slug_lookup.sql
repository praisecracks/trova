-- 028_add_storefront_slug_lookup.sql
-- Allow public storefront lookup by business name in addition to handle
-- Supports storefront URLs like /store/business-name
